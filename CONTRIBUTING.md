# Contributing to Pimcore Perspective Editor
...
* [Open an issue](https://github.com/pimcore/perspective-editor/issues) here on GitHub. 
...
* Please be patient as not all items will be tested immediately - remember, Pimcore Perspective Editor is open source and free of charge. 
...
* Select the right branch. `main` for features and improvements, latest maintenance branch for bug fixes (e.g. `6.6`) 
* Code! Follow the coding standards defined [here](https://github.com/pimcore/perspective-editor/blob/master/.php_cs.dist).
* [Send a pull request](https://help.github.com/articles/using-pull-requests/) from your fork’s branch to our `master` branch.
* [Sign the CLA](https://cla-assistant.io/pimcore/perspective-editor) - see also below.
